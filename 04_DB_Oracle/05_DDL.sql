/*
    ...
    오라클에서 제공하는 객체(구조) / 스키마(Schema)
        : 테이블(TABLE), 뷰(VIEW), 시퀀스(SEQUENCE)
          ...
          프로시저(PROCEDEURE), 함수(FUNCTION), 동의어(SYNONYM),
          사용자(USER)                         
*/
/*
    CREATE 
    ...
    테이블 생성
    테이블이란? 행(ROW)과 열(COLUMN)로 구성되는가장 기본적인 데이터베이스 객체
...
INSERT INTO MEM_PRI2 VALUES(MEM_SEQ.NEXTVAL, 'user01', 'pass01', '윤의진', '남', '010-1111-2222', 'aaa@naver.com', '25/06/05');
INSERT INTO MEM_PRI2(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, MEM_DATE, GENDER) 
            VALUES(MEM_SEQ.NEXTVAL, 'user02', 'pass02', '이진용', SYSDATE, '남');
INSERT INTO MEM_PRI2(MEM_NO, MEM_ID, MEM_PWD, MEM_NAME, GENDER, MEM_DATE, EMAIL)
            VALUES(MEM_SEQ.NEXTVAL, 'user03', 'pass03', '곽병현', '남', SYSDATE, 'bbb@google.com');
SELECT * FROM MEM_PRI2;
...
SELECT MEM_ID, MEM_NAME, GRADE_NAME
FROM MEM_MEMBER 
...
VALUES('윤의진');
INSERT INTO MEMBER(MEM_NAME, MEM_AGE) 
VALUES ('이진용', 20);
INSERT INTO MEMBER(MEM_NAME, MEM_AGE, HOBBY) 
VALUES('곽병현', 15, '영화 감상');
SELECT * FROM MEMBER;
...
VALUES('오픈도어북스', '070-4170-1080');
INSERT INTO PUBLISHER(PUB_NAME, PHONE)
VALUES('모티브', '02-3141-6921');
...
VALUES(USER_INFO_SEQ.NEXTVAL, '테스트');
...
*/
ALTER TABLE DEPT_COPY
RENAME CONSTRAINT SYS_C008371 TO DEPT_ID_PK;
