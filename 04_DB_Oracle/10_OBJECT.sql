...
-- INSERT
INSERT INTO VW_JOB VALUES('J8', '인턴'); -- JOB_CODE가 NOT NULL 제약조건이 있어서
...
UPDATE VW_EMP_SAL
SET 연봉 = 96000000
WHERE EMP_ID = 300; -- 가상 열은 사용할 수 없습니다
...
VALUES("D0", 1000000, 100000); -- 그룹 함수들은 이미 계산된 함수식이기 때문에
...
END;
/
INSERT INTO EMPLOYEE(EMP_ID, EMP_NAME) VALUES(405, '강성모');
