...
public class D_While {
	 ...
	 * */
	 ...
	 /*
	  * 숫자 맞히기 게임
	  * 1과 100사이의 값 중에 정답을 저희가 정하고 컴퓨터(random)가 맞히도록! 몇 번만에 끝내는지 출력!
	 ...
	 public void method4() {
		 ...
		 while(true) {
			 ++count;
			 int random = (int)(Math.random() * (max-min+1) + min); // 1~2
			 if(number > random) { 
				 // 10 -> 11 ~ 100
	  ...
	  * 숫자 맞히기 게임 2
	  * 
	  * 컴퓨터(random) 1과 100사이의 값 중에 저희가 정답을 맞히도록! 몇 번만에 끝내는지 출력!
	  * 해당 숫자보다 정답이 높으면 Up! 낮으면 Down!
	  */
	 public void method5() {
