...
public class Application {
	...
	public static void main(String[] args) {
		...
		//System.out.println();
		//System.out.println(customer2.getName() + "님의 등급은 " + customer2.getGrade() + "이며, 지불해야 하는 금액은 " + (price * customer2.getSaleRatio()) + "원이며, 적립된 포인트는 " + (price * customer2.getBonusRatio()) + "점입니다.");
