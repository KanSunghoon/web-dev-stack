...
public class B_Time {
	...
	public void method1() {
		...
		LocalDateTime minusDay = now.minusYears(1);
		System.out.println("minus" + minusDay);
		
		LocalDateTime withDay = now.withYear(2026).withMonth(8).withMonth(8).withDayOfMonth(15);
		System.out.println("with :" + withDay);
		
		System.out.println("isAfter : " + now.isBefore(withDay)); // 오늘이 해당 날짜보다 이후인가?
	...
	public void method2() {
		...
		System.out.println("minute : " + du.toHours());
		System.out.println("second : " + du.toHours());
