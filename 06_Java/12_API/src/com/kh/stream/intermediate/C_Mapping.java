...
public class C_Mapping {
	...
	public void method2() {
		List<String> list = Arrays.asList("Java Lambda", 
								"Stream Filtering Sorted Mapping");
		list.stream()
		/*
			.flatMap((String str) -> {
		    ...
		    .forEach(System.out::println); // 위에 해당 라인 함축된 표현!
	}
	
	/*
	 * sDoubleStream(), asLongStream(), boxed()
	 * - asDoubleStream : IntStrean, LongStream을 DoubleStream으로 변환
