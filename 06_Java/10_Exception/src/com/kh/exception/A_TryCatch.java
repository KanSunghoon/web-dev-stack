...
public class A_TryCatch {
	 ...
	 * 
	 * 에러는 메모리 부족(OutOfMemoryError)이나 스택오버플로수(StackOverflowError)
	 * 와 같이 일단 발생하면 복구 할 수 없는 심각한 오류
	 * 
	 * 예외는 발생하더라도 수습될 수 있는 비교적 덜 심각
	 * 
	 * Object -> Throwable -> Exception
	 * --> IOException -> FileNitFoundException, SocketException
	...
	public static void main(String[] args) {
		try {
			...
			// primtStack : 예외발생 당시의 호출스택(Call Stack)에 있었던 메서드의 정보와 예외 메시지를 화면에 출력
			e.printStackTrace();
