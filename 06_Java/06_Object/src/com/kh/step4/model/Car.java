...
public class Car {
	 ...
	 * - 클래스, 변수, 메서드, 생성자에 사용되어 외부로부터 접근 제한
	 * 
	 * + public : 접근 제한이 전혀 없음
	 ...
	 * - 반환형이 존재하지 않음 -> 만약 return이 있다면 메서드로 인식
	 * 
	 ...
	 */
	// 오버로딩 : 한 클래스 내에 동일한 이름의 메서드를 파라미터의 자료형과 개수, 순서가 다르게 작성된 경우
	// 기본 생성자
	public Car() {}
	
	public Car(String color, String gearType, int door) {
		/*
		 * this : 자신을 가리키는 참조변수. 객체 주소가 저장되어 있음. 모든 인스턴스 메서드에 지역변수로 숨겨진 채 존재
		 * 
		 */
		this.color = color;
