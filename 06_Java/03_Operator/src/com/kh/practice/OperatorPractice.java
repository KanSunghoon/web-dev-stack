...
public class OperatorPractice {
	...
	public void method1() {
		...
		System.out.println("동일하게 나눠가진 연필 개수 : " + number / number1);
		System.out.print("나눠주고 남은 연필 개수 : " + number % number1);
	...
	public void method5() {
		...
		char noChar = sc.nextLine().charAt(7);
